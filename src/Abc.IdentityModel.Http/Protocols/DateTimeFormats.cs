// ----------------------------------------------------------------------------
// <copyright file="DateTimeFormats.cs" company="ABC Software Ltd">
...
namespace Abc.IdentityModel.Protocols {
    ...
    internal static class DateTimeFormats {
        ...
        /// </summary>
        public const string Generated = "yyyy-MM-ddTHH:mm:ss.fffZ";

        /// <summary>
        /// Accepted Date time formats.
        /// </summary>
        public static readonly string[] Accepted = new string[] {

// ----------------------------------------------------------------------------
// <copyright file="SamlArtifact1.cs" company="ABC Software Ltd">
...
namespace Abc.IdentityModel.Protocols {
    ...
    public sealed class SamlArtifact1 : SamlArtifact {
        private const short ArtifactTypeCode = 0x01;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SamlArtifact1"/> class.
        /// </summary>
        public SamlArtifact1()
        ...
        public SamlArtifact1(string identificationUrl)
            : base(ArtifactTypeCode) {
        ...
        public SamlArtifact1(byte[] sourceId, byte[] assertionHandler)
            : base(ArtifactTypeCode) {
        ...
        public static bool operator ==(SamlArtifact1 samlArtifact1, SamlArtifact1 samlArtifact2) {
            return SamlArtifact1.Equals(samlArtifact1, samlArtifact2);
        }
        ...
        public static bool Equals(SamlArtifact1 samlArtifact1, SamlArtifact1 samlArtifact2) {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="string"/> to <see cref="SamlArtifact1"/>.
        /// </summary>
        /// <param name="artifact">The artifact.</param>
        /// <returns>The result of the conversion.</returns>
        public static implicit operator SamlArtifact1(string artifact) {
            if (artifact == null) {
                return null;
            }

            var samlArtifact = new SamlArtifact1();
            samlArtifact.LoadArtifactFromString(artifact);
            return samlArtifact;
        }

        /// <summary>
        /// Performs an implicit conversion from <see cref="SamlArtifact1"/> to <see cref="string"/>.
        /// </summary>
        /// <param name="samlArtifact">The saml artifact.</param>
        /// <returns>The result of the conversion.</returns>
        public static implicit operator string(SamlArtifact1 samlArtifact) {
        ...
        public override bool Equals(object obj) {
            if (obj == null || obj.GetType() != typeof(SamlArtifact1)) {
                return false;
            }

            return SamlArtifact1.Equals(this, (SamlArtifact1)obj);  
        }
